"""In-process seed for the Recipes surface.

Ported exactly from frontend/src/data/RecipeLibrary/RecipeLibrary-data.ts.
No network, no file I/O. Duplicate/customize stays local/simulated in the UI;
...
SEED_RECIPES: list[Recipe] = [
    Recipe(
        ...
        description=(
            "Find and deduplicate papers from OpenAlex and Crossref for a research question."
        ...
        privacyPolicy="All data stays on your device. No information leaves your network.",
    ),
    Recipe(
        id="rec-002",
        name="Full systematic review",
        description=(
            "Complete PRISMA-compatible systematic review with cloud-assisted screening."
        ...
        inputs=["Research question", "PICO criteria", "Date range", "Anthropic API key"],
        outputs=["evidence.xlsx", "prisma-flowchart.md", "review.bib", "provenance.json"],
    ...
    Recipe(
        ...
        description="Build a co-authorship network from an existing paper set.",
        execution="local",
        steps=[
            "Load paper records",
    ...
    Recipe(
        ...
        description="Generate a draft synthesis of included evidence with source citations.",
        execution="cloud",
        steps=[
        ...
        privacyPolicy=(
            "Included paper abstracts and titles are sent to Anthropic. You review and approve"
